	...
	<html>
		...
		<body>
			<form method="GET" name="fmes" action="saldosMensaisPlan.php">
				<center>
					<img src="receitas-despesas.jpg" width="15%" />
					<h1>Sistema de Controle de Finanças Empresarial </h1>
					<hr width="700px" /><br />
					<p>Favor , escolha o mes que deseja visualizar:
					<select name="mes" onchange="this.form.submit()">
						<option value="1" onclick="fmes.submit()">Janeiro</option>
						<option value="2" onclick="fmes.submit()">Fevereiro</option>
						<option value="3" onclick="fmes.submit()">Março</option>
						<option value="4" onclick="fmes.submit()">Abril</option>
						<option value="5" onclick="fmes.submit()">Maio</option>
						<option value="6" onclick="fmes.submit()">Junho</option>
						<option value="7" onclick="fmes.submit()">Julho</option>
						<option value="8" onclick="fmes.submit()">Agosto</option>
						<option value="9" onclick="fmes.submit()">Setembro</option>
						<option value="10" onclick="fmes.submit()">Outubro</option>
						<option value="11" onclick="fmes.submit()">Novembro</option>
						<option value="12" onclick="fmes.submit()">Dezembro</option>
					</select >
					</p>
					<?php if (isset($mes)) { ?>
