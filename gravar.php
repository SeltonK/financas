<?php
	...
	if(empty($nome) or empty($valor)){
		...
		$resultado =
		mysql_query("SELECT id FROM usuario WHERE login='$nome_usuario'");
...
VALUES ('$nome', '$t', '$classe', '$mesRef', '$datahora', '$valor', '$idUsuario', '$descricao')";
		// $comandoSQL = "INSERT into 'exemplo_ntwi'.'receitas_despesas' ('nome','tipo','classe','mes_referencia','datahora','valor','usuario','descricao')  values";
