<?php
	...
	$resultado = mysql_query("SELECT * FROM usuario where login= '$username'") or die(mysql_error());
	...
	if($linhas==0){ // testa se a consulta retornou algum registro
		...
		if ($senha != mysql_result($resultado , 0, "senha")){ // confere senha
			echo '<html><head><link rel="stylesheet" type="text/css" href="css/skeleton.css">
<link rel="stylesheet" type="text/css" href="css/normalize.css"></head><body>';
